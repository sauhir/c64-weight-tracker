...
all:
	cl65 --standard c89 -Osir tokens.c config.c wtrack64.c -o wtrack64.prg

run:
	cl65 --standard c89 -Osir tokens.c config.c wtrack64.c -o wtrack64.prg && open wtrack64.prg
